...
# in turn import `voxd.paths`, `voxd.core.config`, …) as that easily leads to
...
@lru_cache(maxsize=1)
def _app_cfg():
    """Return a cached instance of :class:`voxd.core.config.AppConfig`."""
    ...
    from voxd.core.config import AppConfig  # local import – deliberate
